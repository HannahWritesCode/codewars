...
print(song_decoder('WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB')) #WE ARE THE CHAMPIONS
print(song_decoder('WUBWUBMR.WUBWUBWUBBRIGHTSIDE')) #MR. BRIGHTSIDE
print(song_decoder('WUBWUBWUBWUBWUBCOUGHWUBWUBWUBWUBSYRUPWUBSUB')) #COUGH SYRUP
print(song_decoder('WUBSTRAWBERRYWUBWUBWUBLETTERWUB22WUB')) #STRAWBERRY LETTER 22
print(song_decoder('WUBWUBYYZWUB')) #YYZ